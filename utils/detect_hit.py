        ...
        if(cX != None and cY != None):
            ...
            if(flag > 0):
                ...
                if(len(hit_area) != 0):
                    ...
                    try:
                        cv2.floodFill(frame, mask, (cX, cY), (0, 0, 255),
                                      (90, 90, 90), (10, 10, 10), flags=8)

                        cv2.drawContours(passed_in_dialation_copy, [
                                         hit_area], -1, (255, 255, 255), 2)
                        cv2.floodFill(passed_in_dialation_copy, mask, (cX, cY),
                                      (0, 0, 255), (90, 90, 90), (10, 10, 10), flags=8)
